...
export const initialMockActivityFeed = [
    { id: '1', type: 'nft_listing', user: { walletAddress: ADMIN_WALLET_ADDRESS, name: 'BlockChat', avatar: 'https://i.imgur.com/siB8l8m.png', isAdmin: true }, nft: initialMockMarketplaceNfts[0], timestamp: new Date(Date.now() - 2 * 86400000).toISOString(), likes: 25, comments: 2, commentData: [
    ...
    { id: '2', type: 'status_update', user: { walletAddress: 'some-user-wallet-address', name: 'Alice', avatar: 'https://i.pravatar.cc/150?u=alice', isVip: true }, content: 'Just joined BlockChat, looks awesome!', likes: 15, comments: 0, commentData: [], timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
];
...
export const initialTokenPerformanceFeed = [
    { id: 'tp-1', user: { walletAddress: 'analyst-wallet-1', name: 'CryptoChad', avatar: 'https://i.pravatar.cc/150?u=chad', isVip: true, isVerified: true }, tokenSymbol: 'SOL', content: 'Seeing strong bullish signals on the 4-hour chart for SOL. Expecting a push towards $180 soon. #Solana', likes: 120, comments: 15 },
    { id: 'tp-2', user: { walletAddress: 'trader-wallet-2', name: 'WojakWhale', avatar: 'https://i.pravatar.cc/150?u=wojak', isVip: true, isVerified: false }, tokenSymbol: 'WIF', content: 'dogwifhat is looking a bit overextended here. Taking some profits off the table. Might re-enter on a dip.', likes: 75, comments: 8 },
];